...
const programs = [
  {
    ...
    body: "Personalized academic mentorship that helps students navigate the British Columbia curriculum, build strong study habits, and chart a clear path from high school through to university.",
    items: [
  ...
  },
  {
    ...
    body: "Customized short-term programs — summer camps, winter camps, professional development, and tailored group experiences — set in authentic Canadian learning environments.",
    items: [
      "Summer Camps",
      "Winter Camps",
