...
const programs = [
  {
    ...
    body: "Personalized academic mentorship that helps students navigate the British Columbia curriculum, strengthen study skills, and chart a clear path from high school through to university.",
    points: [
  ...
  },
  {
    ...
    body: "End-to-end support for students applying to leading universities in Canada, the United States, and the United Kingdom — including portfolio development, essay coaching, and interview preparation.",
    points: [
  ...
  {
    img: mentorshipImg,
    eyebrow: "03 · Short Programs",
    title: "Short Programs",
    body: "Customized short-term programs that bring international students and educators into authentic Canadian learning environments — designed around each group's goals and timeline.",
    points: [
      "Summer Camps",
      "Winter Camps",
